...
class MoviesCollectionCollectionViewController: UICollectionViewController {
    ...
    var selectedPSystem: ProfitSystem!
    ...
    func layoutCollectionView() {
        ...
        layout.itemSize = CGSize(width: ((screenWidth - 80) / 5), height: (screenWidth / 6) * 1.8)
    ...
    func createObjects() {
        ...
        for c in courses {
            ...
            profitSystems.append(ProfitSystem(title: c.name, cover: c.coverArtFileName, learnID: c.id, desc: c.description, segments: segments))
        }
    }
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        selectedPSystem = profitSystems[indexPath.item]
        cell.titleLbl.text = selectedPSystem.title
        cell.thumbnail.adjustsImageWhenAncestorFocused = true
        
        let coverArt = selectedPSystem.cover
        ...
        cell.accessibilityLabel = selectedPSystem.title
        return cell
    }
    
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        selectedPSystem = profitSystems[indexPath.item]
        print(selectedPSystem.title)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "showMoviesDetail" {
            ...
            vc.passedProfitSystem = selectedPSystem
        }
    }
}
